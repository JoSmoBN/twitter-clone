...
$(document).ready(function() {
  ...
  function newTweet(tweet, tweetId) {
    ...
    $('#stream').prepend(function() {
      return '<div class="tweet" id=' + String(localData[localData.length-1].tweetId) + '> <div class="content"> <img class="avatar" src="https://pbs.twimg.com/profile_images/2559712231/jc9uzsknmpesqfecjngf_bigger.jpeg" /> <strong class="fullname">Joseph Tweet</strong> <span class="username">@josephbnolan</span> <p class="tweet-text">' + tweet + '</p> <div class="tweet-actions"> <ul> <li><span class="icon action-reply"></span> Reply</li> <li><span class="icon action-retweet"></span> Retweet</li> <li><span class="icon action-favorite"></span> Favorite</li> <li><span class="icon action-more"></span> More</li> </ul> </div> <div class="stats"> <div class="retweets"> <p class="num-retweets">0</p> <p>RETWEETS</p> </div> <div class="favorites"> <p class="num-favorites">0</p> <p>FAVORITES</p> </div> <div class="users-interact"> <div> <img src="https://pbs.twimg.com/profile_images/2559712231/jc9uzsknmpesqfecjngf_bigger.jpeg" /> </div> </div> <div class="time">' +  $.timeago(new Date()); + ' </div> </div> <div class="reply"> <img class="avatar" src="https://pbs.twimg.com/profile_images/2559712231/jc9uzsknmpesqfecjngf_bigger.jpeg" /> <textarea class="tweet-compose" placeholder="Reply to @josephbnolan"/></textarea> </div> </div> </div>';
    });
  }
